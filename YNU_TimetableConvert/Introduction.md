...
* 在负一屏中找到“搜索服务”搜索框或一个加号的按钮，点击进入后搜索“日程”并将其添加到负一屏
    ![append_page](./README_Pics/append_page.jpg)
    ![append_page_2](./README_Pics/append_page_2.jpg)
* 随后通过负一屏的卡片进入日程，如果右下角有这个图标，则可以通过其导入课程表。
    ![append_page_3](./README_Pics/append_page_3.jpg)
    ![calender](./README_Pics/calender.jpg)

> 从官网下载课表文件（以Excel格式保存）

* 进入 [云南大学网上服务大厅](https://ehall.ynu.edu.cn/new/index.html)，并登录
* 在主页左侧找到“可用应用”-“本科教务”-“个人服务”的“我的课表”
![homepage](./README_Pics/homepage.jpg)
* 在确认当前课程表为本学期后，点击左上角的“下载”，在弹出窗口选择“导出为Excel”，即可完成保存
![courses](./README_Pics/courses.jpg)
![courses_output](./README_Pics/courses_output.jpg)
...
![calender_import](./README_Pics/calender_import.jpg)
* 效果如下图
![HWCalender_disp](./README_Pics/HWCalender_disp.jpg)
